 ...
 public class PNotifyMessage extends gkfire.web.util.JavaScriptMessage {
   ...
   public static void errorMessage(String content) {
     new PNotifyMessage("ERROR", content, Type.Danger, "fa fa-warning shaked animated", 3000L).execute();
   }
   
   public static void infoMessage(String content) { new PNotifyMessage("INFO", content, Type.Info, "fa fa-exclamation shaked animated", 3000L).execute(); }
   ...
   public static void systemError(Exception ex, AbstractSessionBean sessionBean) {
     errorMessage("Consulte el log de la app CODE : " + sessionBean.addError(ex));
   }
